                                ...
                                ListTile(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () => showConfirmationDialog(
                                      ...
                                      body: "Are you sure you want to remove '${member.name}'",
                                      onConfirm: () {
                                        di<AppState>().deleteMember(member.id);
                                      },
                                    ),
                                  ),
                                ),
                                ...
                                ListTile(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () => showConfirmationDialog(
                                      ...
                                      body: "Are you sure you want to delete '${song.name}'",
                                      onConfirm: () {
                                        di<AppState>().deleteSong(song.id);
                                      },
                                    ),
                                  ),
                                ),
